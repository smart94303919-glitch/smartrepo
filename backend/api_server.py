...
def extract_sheet_identity(header_image: np.ndarray) -> tuple[str, str]:
...
def parse_qr_payload(raw_payload: str) -> tuple[str, str]:
    ...
    try:
        ...
        if isinstance(parsed, dict):
            ...
            return student_id, sheet_id or "UNKNOWN"
...
def grade_sheet(
    ...
    resolved_student_id, response_sheet_id = extract_sheet_identity(warped)
    qr_identity_found = (
